...
<body>
    <div class="container">
        ...
        <div class="page-header">
            <h2><i class="fas fa-book"></i>Data Pegawai</h2>
            <p>Kelola data pegawai SMK Negeri 1 Sukawati</p>
        </div>
        ...
        $total_pegawai = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM pegawai");
            ...
            <div class="stats-card primary">
                <div class="stats-card-header">
                    <div>
                        ...
                        <div class="stats-card-title">Total Pegawai</div>
                    </div>
        ...
        <div class="content-container">
            ...
            <div class="action-bar">
                ...
                <a href="pegawai_tambah.php" class="btn-primary">
