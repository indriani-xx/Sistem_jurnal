        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <select name="id_jurusan" class="form-select" required>
                <?php 
                    // ambil data guru
                    $id_jurusan = mysqli_query($koneksi, "SELECT * FROM jurusan ORDER BY nama_jurusan ASC");
                    while ($row = mysqli_fetch_assoc($id_jurusan)) { $selected = ($row['id_jurusan'] == $data['id_jurusan']) ? "selected" : "";
